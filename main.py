# FIX: Use non-interactive matplotlib backend for headless cluster nodes (no display server)
import matplotlib
matplotlib.use('Agg')
...
# FIX: geoopt_plusplus is nested inside models/hyperbolic_nn_plusplus/ but imported as top-level.
# Without this sys.path, you get: ModuleNotFoundError: No module named 'geoopt_plusplus'

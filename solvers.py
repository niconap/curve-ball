...
def projx_integrator_return_last(
    ...
    step_fn = {
        ...
        # EDIT
        # RG-VFM: same integrator as x1_prediction  we walk a fraction of the geodesic
        # toward the predicted endpoint mean. sigma is only used during training.
    ...
    for t0, t1 in zip(t0s, t[1:]):
        ...
        # EDIT
        # RG-VFM model returns (mu, log_sigma2); sampling only uses mu.
